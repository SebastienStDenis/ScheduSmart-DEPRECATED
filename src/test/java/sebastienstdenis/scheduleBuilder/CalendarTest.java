...
public class CalendarTest {
	...
	public void testAddRemoveComponent1() {
		...
		assertTrue(sched.getComponents().contains(comp1));
		assertTrue(sched.getComponents().contains(comp2));
		
		cal.removeComponent(comp1);
		sched = cal.makeSchedule();
		assertFalse(sched.getComponents().contains(comp1));
		assertTrue(sched.getComponents().contains(comp2));
	...
	public void testAddRemoveCopmonent3() {
		...
		assertTrue(sched.getComponents().contains(comp1));
		assertTrue(sched.getComponents().contains(comp2));
		assertTrue(sched.getComponents().contains(comp3));
		...
		assertTrue(sched.getComponents().contains(comp1));
		assertTrue(sched.getComponents().contains(comp2));
		assertFalse(sched.getComponents().contains(comp3));
	...
	public void testAddRemoveCopmonent4() {
		...
		Schedule sched = cal.makeSchedule();
		assertTrue(sched.getComponents().contains(comp1));
		assertFalse(sched.getComponents().contains(comp2));
	}
